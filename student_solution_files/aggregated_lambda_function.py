...
def lambda_handler(event, context):
    ...
    # ** Insert code to write to dynamodb ** 
     rid = random.randint(1,1000000) # <--- Replace this value with your code.
    # -----------------------------
    ...
    # --- Insert your code here ---
    enquiry_text = dec_dict['message'] # <--- Website message will be placed into this variable
    # -----------------------------
    ...
    name = dec_dict['name']
    critical_phrase_list = key_phrases
